...
public:
  ...
  // Comparison operators
    ...
    bool operator != (const InOrderFoldableContainer&) const noexcept = delete; // type operator!=(argument) specifiers; // Comparison of abstract types might not be possible.
